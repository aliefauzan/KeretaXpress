...
export default function BookingsPage() {
  ...
  const getStatusBadge = (status: string, paymentStatus: string) => {
    if (paymentStatus === 'paid') {
      ...
      return (
        <span className="inline-flex items-center space-x-1 px-3 py-1 text-xs font-semibold bg-gray-100 text-gray-800 rounded-full">
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Train</th>
                ...
                <th className="px-6 py-3 text-center text-xs font-semibold text-gray-700 uppercase tracking-wider">Passengers</th>
          ...
          <div className="px-6 py-4 border-t border-gray-200 flex items-center justify-between bg-gray-50">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="px-4 py-2 border border-gray-300 rounded-lg hover:bg-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm font-medium"
              >
                Previous
              </button>
              <button
            ...
            <form onSubmit={handleConfirmPayment} className="p-6 space-y-4">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center space-x-3 p-3 border-2 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors border-gray-200 hover:border-gray-300">
                    <input
                      type="radio"
                      value="paid"
